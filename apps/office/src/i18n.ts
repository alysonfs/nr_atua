...
const ptBR = {
  ...
  dashboard: {
    ...
    statuses: {
      ...
      exchangeApproved: 'Troca Aprovada',
      closed: 'Fechado',
      cancelled: 'Cancelado',
    ...
    kpi: {
      created: { label: 'OS criadas (mês)' },
      completed: { label: 'OS concluídas (mês)' },
      completionRate: { label: 'Taxa de conclusão' },
      totalActive: { label: 'Total de OS' },
      comparisonPeriod: 'vs. mês anterior',
      new: 'Novo',
    },
    metrics: {
      trendTitle: 'OS criadas x concluídas',
      distributionTitle: 'Distribuição por status',
      otherStatus: 'Outros',
      loading: 'Carregando gráficos...',
      error: 'Não foi possível carregar os gráficos. Tente novamente mais tarde.',
    },
  },
  workOrderDetail: {
...
const enUS = {
  ...
  layout: {
    ...
    alerts: 'Notifications', settings: 'Settings', signOut: 'Sign out',
    signOutAria: 'Sign out of account', sideMenu: 'Side menu', mainNavigation: 'Main navigation',
    menu: 'Menu', dashboard: 'Dashboard', account: 'Account', accountMenuAria: 'Open account menu',
  ...
  dashboard: {
    ...
    statuses: {
      requestCancel: 'Cancellation Requested', assigned: 'Assigned', accepted: 'Accepted',
      exchangeProposal: 'Exchange Proposal', exchangeApproved: 'Exchange Approved',
    ...
    kpi: {
      created: { label: 'Created work orders (month)' },
      completed: { label: 'Completed work orders (month)' },
      completionRate: { label: 'Completion rate' },
      totalActive: { label: 'Total work orders' },
      comparisonPeriod: 'vs. previous month',
      new: 'New',
    },
    metrics: {
      trendTitle: 'Created vs completed work orders',
      distributionTitle: 'Distribution by status',
      otherStatus: 'Other',
      loading: 'Loading charts...',
      error: 'Unable to load the charts. Please try again later.',
    },
  },
  workOrderDetail: {
...
const esAR = {
  ...
  layout: {
    ...
    alerts: 'Notificaciones', settings: 'Configuración', signOut: 'Salir',
    signOutAria: 'Cerrar sesión', sideMenu: 'Menú lateral', mainNavigation: 'Navegación principal',
    menu: 'Menú', dashboard: 'Panel', account: 'Cuenta', accountMenuAria: 'Abrir menú de la cuenta',
  ...
  dashboard: {
    ...
    kpi: {
      created: { label: 'OS creadas (mes)' },
      completed: { label: 'OS completadas (mes)' },
      completionRate: { label: 'Tasa de finalización' },
      totalActive: { label: 'Total de OS' },
      comparisonPeriod: 'vs. mes anterior',
      new: 'Nuevo',
    },
    metrics: {
      trendTitle: 'OS creadas vs completadas',
      distributionTitle: 'Distribución por estado',
      otherStatus: 'Otros',
      loading: 'Cargando gráficos...',
      error: 'No fue posible cargar los gráficos. Intentá nuevamente más tarde.',
    },
    ...
    statuses: {
      requestCancel: 'Cancelación Solicitada', assigned: 'Asignado', accepted: 'Aceptado',
      exchangeProposal: 'Propuesta de Cambio', exchangeApproved: 'Cambio Aprobado',
